...
file_name = r'C:\Users\bitcamp\Desktop\opencv_dnn_202005\image'
title_name = 'Haar cascade object detection'
frame_width = 500

def selectFile():
    file_name = filedialog.askopenfilename(initialdir = r"C:\Users\bitcamp\Desktop\opencv_dnn_202005\image", 
...
read_image = cv2.imread(r'C:\Users\bitcamp\Desktop\opencv_dnn_202005\image\marathon_01.jpg')
(height, width) = read_image.shape[:2]
...
if not face_cascade.load(cv2.samples.findFile(face_cascade_name)):
    print('--(1)Error loading face cascade')
    exit(0)
