...
for i in range(len(multi_XGB.estimators_)):
    ...
    for thresh in threshold:
        selection = SelectFromModel(multi_XGB.estimators_[i], threshold = thresh, prefit = True)
        ...
        submission.to_csv('./dacon/comp1/sample_submission.csv'%(i, mae),index = True, header=['hhb','hbo2','ca','na'], index_label='id')
