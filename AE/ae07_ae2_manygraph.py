...
model_01 = autoencoder(hidden_layere_size=1)
model_02 = autoencoder(hidden_layere_size=2)
model_04 = autoencoder(hidden_layere_size=4)
model_08 = autoencoder(hidden_layere_size=8)
model_16 = autoencoder(hidden_layere_size=16)
model_32 = autoencoder(hidden_layere_size=32)

model_01.compile(optimizer='adam', loss='mse', metrics=['acc']) # loss = 0.0119
