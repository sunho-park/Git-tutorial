...
from keras.applications import VGG16, VGG19, ResNet101, InceptionV3, MobileNet
...
mobile = MobileNet(include_top=False, weights='imagenet', input_tensor=input_tensor)
